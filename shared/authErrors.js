...
const accessDenied = "Access denied. You do not have permission to view this content.";
...
const expiredForm = expirationDate => `The window to view and update this form was closed on ${expirationDate}.`;
...
const formAlreadyExists = "The selected Enrollment Month dates have already been assigned to another A/P form. Please choose different dates.";

const invalidAuthTokenRequest = "You must supply an email, a role, and a season before you can create an authorization key.";

const invalidContactUsRequest = "Unable to send your message. You must supply a message, subject, and a sendTo address in order to contact us.";
...
const invalidExpirationDate = "The selected 'Expiration Date' has already past. Please select a later date.";

const invalidSendDate = "The selected 'Send Date' has already past. Please select a later date.";

const invalidSendEmailNoteDate = "The selected 'Send Email Notifications Date' has already past. Please select a later date.";

const invalidSession = "Your login session has expired. Please log into your account again.";
...
const invalidStatus = "Your access has been denied. The account you're trying to log into has been suspended.";
...
const invalidUpdateEventRequest = "You must inclide all fields to update an exisiting event.";
...
const mustContainUniqueCallTimes = "One or more of the 'Scheduling Call Times' is a duplicate. Please remove the duplicate(s) before submitting the form again.";
...
const unableToCreateNewMail = "Unable to create a new email. You must provide a message, send to email address(es), send from address, and a subject.";
...
const unableToLocateContacts = "Unable to locate staff or admin contacts. Please try again later.";

const unableToLocateEvent = "Unable to locate that event. That event doesn't exist.";

const unableToLocateEvents = (startMonth, endMonth) => `Unable to locate any events. There doesn't appear to be any events between ${startMonth}-${endMonth}.`;

const unableToLocateForm = "Unable to locate that form. That form doesn't exist.";

const unableToLocateMail = "Unable to locate that email. That email doesn't exist.";

const unableToLocateMember = "Unable to locate that member. That member doesn't exist.";

const unableToLocateMembers = "Unable to locate any members. You need to create members before you can do that.";
...
const unableToUpdateApForm = "Unable to update the A/P form. You must provide an id and all responses.";

const unableToUpdateForm = "Unable to update the existing form. You must provide an id, season id, start of month date, end of month date, and expiration date.";

const unableToUpdateMail = "Unable to update the existing email. You must provide an id, message, send to email address(es) and a subject.";

const unableToUpdateSeason = "Unable to update the existing season. You must provide an id, season id, start date, and end date.";
...
const usernameAlreadyTaken = "The first and last name provided is already in use and is associated with an active account. In order to continue, please use a uniquely identifable name such as a first middle name initial or a nickname.";
