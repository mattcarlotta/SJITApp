export default (CLIENT, firstName, lastName, token) => `<h2 style="margin-bottom: 30px; color: #025f6d;text-align: center;">
  ...
  <div style="margin-bottom: 20px; text-align: center">
    <a style="font-size: 18px; text-decoration: none; line-height: 40px; width: 200px; color: #FFFFFF; background-color: #025f6d; display: inline-block;" href="${CLIENT}/employee/newpassword/verify?token=${token}" target="_blank" rel="noopener noreferrer">Create New Password</a>
  </div>
