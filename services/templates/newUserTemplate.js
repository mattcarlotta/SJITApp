          ...
          <div style="font-size: 16px; padding: 30px; vertical-align: top; display: block; width: 675px; max-width: 675px; margin: 0 auto;">
            <div style="margin-bottom: 30px; margin-top: 15px;">
              <p style="color: #2E323B;">
                <img style="margin-right:20px;" src="https://i.imgur.com/pcu86US.png" height="30px" alt="saplogo.png"></img>
                <img style="margin-right:20px;position: relative;top: -3px;" src="https://i.imgur.com/Clo9cbt.png" height="40px" alt="sharkslogo.png"></img>
                <img style="position: relative;top: -1px;" src="https://i.imgur.com/HTcARsE.png" height="33px" alt="barracudaLogo.png"></img>
              </p>
            </div>
